...
def parse_args(argv):
    ...
    parser.add_option("-c", "--configfile", dest="config_file",
            ...
            help="Decoy Proxy Configuration File",
            metavar="FILENAME")
...
def main():
    ...
    dr2dp_dp.register_dp_recv(conn_monitor.dp_recv, conn_monitor.redirect_flow)
    ...
    ccp_dp = CCP_DP(ccp_listen_addr,
               (proxyhost, proxyport),
               False, conn_monitor,
               {443:ct_tls_dp, 80:ct_http_dp, 
                80:ct_http_uni_dp_nohijack, 
                443:ct_tls_uni_dp_nohijack},
               cvpn_addr=cvpn_addr)
...
if __name__ == '__main__':
    ...
    #  No longer needed. cb-noc-cron-dp deprecated. cbkm run via cron
    #
