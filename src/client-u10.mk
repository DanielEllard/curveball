...
# This is the makefile for the Ubuntu 10.04 client.
#
...
install_pkgs: is_ubuntu1004
	sudo apt-get -y install python2.7 curl swig
	curl -O http://python-distribute.org/distribute_setup.py
	sudo python2.7 ./distribute_setup.py
	rm -f distribute_setup.py
	sudo easy_install-2.7 M2crypto
	sudo easy_install-2.7 twisted
	sudo easy_install-2.7 ipaddr
